...
function StateSplash_Setup()
{
  ...
  keyboardText = new Text(
    "[Keyboard] Press space", SMALL_TEXT_FONT_SIZE, SMALL_TEXT_FONT_NAME
  );
  mouseText = new Text(
    "[Mouse] Click any button", SMALL_TEXT_FONT_SIZE, SMALL_TEXT_FONT_NAME
  );

  const version =
    String_Cat("v", NUCLEAR_RAIN_VERSION, " - ", NUCLEAR_RAIN_AUTHOR);
