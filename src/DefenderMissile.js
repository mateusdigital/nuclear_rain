...
//----------------------------------------------------------------------------//
//------------------------------------------------------------------------------
const DEFENDER_GENERATOR_MAX_MISSILES        = Infinity;
const DEFENDER_GENERATOR_MAX_SHOOT_TIME      = 0.3;
const DEFENDER_GENERATOR_MAX_ACTIVE_MISSILES = 4;
