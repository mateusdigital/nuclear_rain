...
{
    CurrContext.translate(x, y);
}

//------------------------------------------------------------------------------
function Canvas_Rotate(a)
{
    CurrContext.rotate(a);
}
...
{
    CurrContext.fillStyle = style;
}

//------------------------------------------------------------------------------
function Canvas_SetStrokeStyle(style)
{
    CurrContext.strokeStyle = style;
}

function Canvas_SetStrokeSize(size)
{
    CurrContext.lineWidth = size;
}
...
//------------------------------------------------------------------------------
function Canvas_FillCircle(x, y, r)
{
    Canvas_FillArc(x, y, r, 0, MATH_2PI);
}
...
function Canvas_LockPixels()
{
    ...
    _Canvas_ImageData = CurrContext.getImageData(0, 0, Canvas_Width, Canvas_Height);
}
